...
void vbe_init()
{
    ...
    regs.di = 0xF000;
    int32(0x10, &regs);
    //putd(vbeInfo->video_modes, 0, 10, 0x0C);
    ...
    regs2.di = 0xEE00;
    int32(0x10, &regs2);
    putd(regs2.ax, 0, 12, 0x0E);
    putd(vbeModeInfo->bpp, 0, 13, 0x0E);
    putd(vbeModeInfo->height, 0, 14, 0x0E);
    putd(vbeModeInfo->width, 0, 15, 0x0E);
    putd(vbeModeInfo->framebuffer, 0, 16, 0x0E);
